        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-3 gap-4 border-b border-[#3d342f]">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto justify-between">
            <div className="flex items-center gap-3.5">
              ...
              >
                <div
                  className="w-9 h-9 rounded-xl flex items-center justify-center shadow-md border border-[#c58a4b]/40 bg-gradient-to-br from-[#2c221a] via-[#1c1815] to-[#12100e] text-[#c58a4b] group-hover:border-[#c58a4b] transition-colors"
                >
